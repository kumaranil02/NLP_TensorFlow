...
# MAGIC
# MAGIC The good news is, we just saved them a lot of time! The last notebook summarised over 3.8 million reviews in 4.5 hours.. That is exceptionally good if we were to compare how long it would take for a team of people to do the same, and also - how dreadful they would find the task after a certain point.. 
# MAGIC
...
# MAGIC
# MAGIC Now that we have our dataframe, we can filter it to create a sub dataframe which will hold the focus weeks that require condensation.
